...
import com.Dao.DeletePetInfoDao;
...
public class DeletePetInfoServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		DeletePetInfoDao dao = new DeletePetInfoDao();
		boolean flag = dao.DeletePetInfo(Integer.parseInt(p_id));
		if(flag){
	        ...
	        out.print("<script>alert(decodeURIComponent('"+a+"') );window.location.href='mainadmin.jsp'</script>");
	       }
	}
